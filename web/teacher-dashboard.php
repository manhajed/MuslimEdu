...
<div class="screen">
  ...
  <div class="glass-card">
    ...
    <div class="glass-row" data-user-code-row><span class="glass-row-icon" id="codeIcon"></span>
      <span><span class="glass-row-label">Staff Code</span><br><span class="glass-row-value" data-user-code>&nbsp;</span></span></div>
  </div>
...
<script>
  ...
  // Copied from src/screens/dashboards/TeacherDashboard.tsx's non-orphan
  // quickActions array (orphan-only tiles like "My Reports"/"Monthly
  // Report" are skipped - those need the isOrphan flag from the school's
  // institution_type, which this page doesn't fetch). First tile renders
  // solid/featured (index 0), same as the RN screen.
  const actions = [
    { title: 'My Schedule', desc: 'See your weekly class timetable', icon: 'calendar' },
    { title: 'Take Attendance', desc: "Mark today's attendance for your classes", icon: 'clipboard' },
    { title: 'Enter Grades', desc: 'Record marks for your assigned subjects', icon: 'star' },
    { title: 'Announcements', desc: 'Post updates to your classes', icon: 'megaphone' },
    { title: 'Behavior & Discipline', desc: 'Log and track student behavior incidents', icon: 'clipboard' },
    { title: 'Student Progress', desc: 'Attendance, grades, and behavior in one view', icon: 'layers' },
    { title: 'Lesson Plans', desc: 'Draft, submit, and revise your lesson plans', icon: 'document' },
    { title: 'Assessments', desc: 'Create assignments, quizzes, and grade submissions', icon: 'clipboard' },
    { title: 'Assessment Grades', desc: 'Weighted grade breakdown for your sections', icon: 'star' },
    { title: 'Materials', desc: 'Share lecture notes, slides, and other resources', icon: 'document' },
    { title: 'Notifications', desc: 'Stay updated with important alerts', icon: 'bell' },
    { title: 'Security', desc: 'Two-factor authentication and device sessions', icon: 'lock' },
  ...
  guardDashboard('teacher', function () {
