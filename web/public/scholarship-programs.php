...
<title>Scholarship Programs — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search programs..." data-i18n-placeholder="scholarship_programs.search_placeholder" autocomplete="off" />
  </div>
...
<script src="scholarship-programs.js"></script>
