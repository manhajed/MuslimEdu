...
<title>Account Settings — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="util-section-title" data-i18n="account_settings.language_appearance_section">Language &amp; appearance</div>
  <div class="util-card" id="langAppearanceCard"></div>

  <div class="util-section-title" data-i18n="account_settings.privacy_section">Privacy</div>
  <div class="util-card" id="privacyCard"></div>

  <div class="util-section-title" data-i18n="account_settings.security_section">Security</div>
  <div class="util-card" id="securityCard"></div>
</div>
