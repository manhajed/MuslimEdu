...
<title>Teachers — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search teachers..." data-i18n-placeholder="teachers_list.search_placeholder" autocomplete="off" />
  </div>
...
<script src="teachers-list.js"></script>
