...
<title>Collect Fees — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search student or invoice..." data-i18n-placeholder="cashier_fees.search_placeholder" autocomplete="off" />
  </div>

  <div class="filter-chip-row" id="filterRow"></div>

  <div id="listContent"></div>
</div>

<script src="dashboard.js"></script>
<script src="cashier-fees.js"></script>
