...
<title>Grading Systems — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="util-section-title" data-i18n="grading_systems.title">Grading Systems</div>
  <div class="util-card" id="gsCard"></div>
  <button type="button" class="util-save-btn pill" id="addGsBtn" data-i18n="grading_systems.add_btn">+ Add Grading System</button>
</div>

<script src="dashboard.js"></script>
<script src="grading-systems.js"></script>
