...
<title>Staff ID Cards — MuslimEdu</title>
...
<style>
  @media print {
    #utilHeaderWrap, #bottomNavWrap, #idListWrap, #tabRow, #idNudgeWrap, .select-bar { display: none !important; }
  }
</style>
</head>
<body>
...
<div class="util-body" id="utilBody" style="display:none;padding-bottom:80px;">
  <div class="id-toolbar" id="idNudgeWrap"></div>
  <div class="role-tab-row" id="tabRow">
    <button type="button" class="role-tab active" data-role="teacher" data-i18n="staff_id_cards.tab_teachers">Teachers</button>
    <button type="button" class="role-tab" data-role="accountant" data-i18n="staff_id_cards.tab_cashiers">Cashiers</button>
    <button type="button" class="role-tab" data-role="registrar" data-i18n="staff_id_cards.tab_registrars">Registrars</button>
  </div>
...
<script src="staff-id-cards.js"></script>
