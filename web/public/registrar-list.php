...
<title>Registrars — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search registrars..." data-i18n-placeholder="registrar_list.search_placeholder" autocomplete="off" />
  </div>
...
<script src="registrar-list.js"></script>
