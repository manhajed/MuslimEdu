...
<div class="screen">
  ...
  <div class="header-row">
    <div>
      <div class="greeting-small" data-i18n="teacher_dashboard.greeting">Assalamu Alaykum,</div>
  ...
  <div class="glass-card">
    <div class="glass-header-row">
      <div class="glass-header-left">
        ...
        <div><div class="glass-title" data-i18n="teacher_dashboard.profile_title">Profile</div><div class="glass-subtitle" data-i18n="teacher_dashboard.profile_subtitle">Your personal information</div></div>
      </div>
    ...
    <div class="glass-row"><span class="glass-row-icon" id="nameIcon"></span>
      <span><span class="glass-row-label" data-i18n="teacher_dashboard.name_label">Name</span><br><span class="glass-row-value" data-user-name>&nbsp;</span></span></div>
    <div class="glass-divider"></div>
    <div class="glass-row"><span class="glass-row-icon" id="mailIcon"></span>
      <span><span class="glass-row-label" data-i18n="teacher_dashboard.email_label">Email</span><br><span class="glass-row-value" data-user-email>&nbsp;</span></span></div>
    ...
    <div class="glass-row" data-user-code-row><span class="glass-row-icon" id="codeIcon"></span>
      <span><span class="glass-row-label" data-i18n="teacher_dashboard.staff_code_label">Staff Code</span><br><span class="glass-row-value" data-user-code>&nbsp;</span></span></div>
  </div>
