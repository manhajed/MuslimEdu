...
<title>Classes & Sections — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search classes..." data-i18n-placeholder="classes_sections.search_placeholder" autocomplete="off" />
    <button type="button" class="list-icon-btn soft" id="filterBtn" aria-label="Filter" style="width:32px;height:32px;flex-shrink:0;">
...
<script src="classes-sections.js"></script>
