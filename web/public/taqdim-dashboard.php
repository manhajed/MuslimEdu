...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="placeholder-center">
    <div class="placeholder-title" data-i18n="taqdim_dashboard.title">Taqdim Assistant</div>
    <div class="placeholder-subtitle" data-i18n="taqdim_dashboard.subtitle">This feature is enabled for your school. Case management (client intake, document review, request tracking) is coming soon.</div>
  </div>
</div>
