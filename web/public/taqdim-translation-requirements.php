...
<title>Requirements — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <button type="button" class="util-save-btn pill" id="addRequirementBtn" style="margin-bottom:14px;">+ Add Requirement</button>
  <div id="requirementsList"></div>
</div>

<script src="dashboard.js"></script>
<script src="taqdim-translation-requirements.js"></script>
