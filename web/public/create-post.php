...
<title>New Post — MuslimEdu</title>
...
<div class="ip-flex" id="cpRoot" style="display:none;">
  <div id="cpStepperWrap"></div>
  <div class="ip-scroll">
    <div class="ip-content" id="cpContent"></div>
  </div>
  <div id="cpFooterWrap"></div>
</div>

<input type="file" id="cpFileInput" accept="image/png,image/jpeg,image/webp" multiple style="display:none;" />
