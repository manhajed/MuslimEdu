...
<title>My Documents — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  ...
  <label class="util-label" style="margin-top:16px;">Upload a new document</label>
  <div class="util-file-input-row"><input type="file" id="uploadFileInput" /></div>
  <button type="button" class="util-save-btn pill" id="uploadBtn" style="margin-top:10px;"><span id="uploadLabel">Upload</span></button>
</div>

<div id="bottomNavWrap"></div>

<script src="dashboard.js"></script>
<script src="scholarship-documents.js"></script>
