...
<title>Students — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search students..." data-i18n-placeholder="students_list.search_placeholder" autocomplete="off" />
