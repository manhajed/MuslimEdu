...
<title>Scholarship Announcements — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="util-section-title">Announcements</div>
  <div id="listContent"></div>
  <button type="button" class="util-save-btn pill" id="addBtn">+ Add Announcement</button>
</div>

<script src="dashboard.js"></script>
<script src="scholarship-announcements.js"></script>
