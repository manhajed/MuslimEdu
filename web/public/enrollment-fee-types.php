...
<title>Fee Types — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="util-hint" style="margin-bottom:14px;" data-i18n="enrollment_fee_types.page_hint">What a student owes during enrollment. Required fees must show Paid or Waived before a student can be officially enrolled.</div>
  <div class="util-card" id="ftCard"></div>
  <button type="button" class="util-save-btn pill" id="addFtBtn" data-i18n="enrollment_fee_types.add_btn">+ Add Fee Type</button>
</div>

<script src="dashboard.js"></script>
<script src="enrollment-fee-types.js"></script>
