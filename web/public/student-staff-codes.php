...
<title>Student & Staff Codes — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="role-tab-row" id="tabRow">
    <button type="button" class="role-tab active" data-tab="student" data-i18n="student_staff_codes.tab_students">Students</button>
    <button type="button" class="role-tab" data-tab="staff" data-i18n="student_staff_codes.tab_staff">Staff</button>
  </div>
...
<script src="student-staff-codes.js"></script>
