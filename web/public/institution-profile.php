...
<title>Institution Profile — MuslimEdu</title>
...
<div class="ip-flex" id="ipRoot" style="display:none;">
  <div id="ipStepperWrap"></div>
  <div id="ipStepLabelWrap"></div>
  <div id="ipErrorBannerWrap"></div>

  <div class="ip-scroll">
    <div class="ip-content" id="ipContent"></div>
  </div>

  <div id="ipStepErrorWrap"></div>
  <div id="ipFooterWrap"></div>
</div>

<!-- Hidden native file pickers - triggered by the avatar/seal tap targets -->
<input type="file" id="logoFileInput" accept="image/png,image/jpeg,image/jpg" style="display:none;" />
<input type="file" id="sealFileInput" accept="image/png,image/jpeg,image/jpg" style="display:none;" />

<script src="dashboard.js"></script>
<script src="institution-profile.js"></script>
