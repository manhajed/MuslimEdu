...
<title>Subjects — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search subjects..." data-i18n-placeholder="subjects_page.search_placeholder" autocomplete="off" />
