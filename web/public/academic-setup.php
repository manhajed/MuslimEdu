...
<title>Academic Setup — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="util-section-title" data-i18n="academic_setup.years_section">Academic Years</div>
  <div class="util-card" id="yearsCard"></div>
  <button type="button" class="util-save-btn pill" id="addYearBtn" style="margin-bottom:24px;" data-i18n="academic_setup.add_year_btn">+ Add Academic Year</button>

  <div class="util-section-title" id="termsSectionTitle" style="display:none;" data-i18n="academic_setup.terms_section">Terms</div>
  <div class="util-card" id="termsCard" style="display:none;"></div>
  <button type="button" class="util-save-btn pill" id="addTermBtn" style="display:none;" data-i18n="academic_setup.add_term_btn">+ Add Term</button>
</div>

<script src="dashboard.js"></script>
<script src="academic-setup.js"></script>
