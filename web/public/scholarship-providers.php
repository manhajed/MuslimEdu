...
<title>Scholarship Providers — MuslimEdu</title>
...
<div class="util-body" id="utilBody" style="display:none;">
  <div class="util-section-title" data-i18n="scholarship_providers.section_title">Providers</div>
  <div class="util-card" id="spCard"></div>
  <button type="button" class="util-save-btn pill" id="addSpBtn" data-i18n="scholarship_providers.add_btn">+ Add Provider</button>
</div>

<script src="dashboard.js"></script>
<script src="scholarship-providers.js"></script>
