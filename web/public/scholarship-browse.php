...
<title>Scholarships — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search scholarships..." data-i18n-placeholder="scholarship_browse.search_placeholder" autocomplete="off" />
  </div>

  <div class="filter-chip-row" id="levelFilterRow"></div>
...
<script src="scholarship-browse.js"></script>
