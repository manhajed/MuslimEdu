...
<title>Resources — MuslimEdu</title>
<meta name="description" content="Onboarding guides, role-specific walkthroughs, and setup checklists for administrators, teachers, registrars, and cashiers are being organized here. I" />
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .content { padding: 28px 22px 40px; flex: 1; }
  h1 { font-family: 'Playfair Display', serif; font-weight: 700; font-size: 26px; color: var(--accent); margin-bottom: 18px; line-height: 1.25; }
  p, .body-text { font-size: 15px; line-height: 1.7; color: var(--text-2); }
...
<div class="screen">
  <div class="topbar">
    ...
    <div class="topbar-title">Resources</div>
  </div>
  <div class="content">
    <h1>Guides &amp; Support Materials</h1>
    <div class="body-text">Onboarding guides, role-specific walkthroughs, and setup checklists for administrators, teachers, registrars, and cashiers are being organized here. In the meantime, reach out through the Help Center link in your dashboard and our team will point you to what you need.</div>
  </div>
  <div class="footer">
