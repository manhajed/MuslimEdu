...
<title>Product — MuslimEdu</title>
<meta name="description" content="Admissions, attendance, fees, grading, communication, and reporting for mahads, madrasas, markaz, schools, and orphanages &mdash; all in a single logi" />
...
<div class="screen">
  ...
  <div class="content">
    <h1>Everything Your School Needs — One App</h1>
    <div class="body-text">Admissions, attendance, fees, grading, communication, and reporting for mahads, madrasas, markaz, schools, and orphanages &mdash; all in a single login, with a role-based dashboard for every admin, teacher, student, parent, registrar, and cashier.</div>
  </div>
  <div class="footer">
