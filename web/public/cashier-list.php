...
<title>Cashiers — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search cashiers..." data-i18n-placeholder="cashier_list.search_placeholder" autocomplete="off" />
  </div>
...
<script src="cashier-list.js"></script>
