...
<title>Translation Requests — MuslimEdu</title>
...
<div class="list-body">
  <div class="list-search-wrap">
    ...
    <input type="text" id="searchInput" placeholder="Search by student or reference no..." data-i18n-placeholder="scholarship_translations.search_placeholder" autocomplete="off" />
  </div>

  <div class="filter-chip-row" id="statusFilterRow"></div>

  <div id="listContent"></div>
</div>

<script src="dashboard.js"></script>
<script src="scholarship-translations.js"></script>
